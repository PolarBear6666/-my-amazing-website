...
//console.log(text1.substring(startIndex. endIndex));
...
let courseNameFormatted= course[0].toUpperCase()+course.slice(1);
console.log(courseNameFormatted);


let course="javASCRIpt";
let courseNameFormatted = course[0].toUpperCase() + 